        ...
        <div className="flex flex-col items-center justify-center text-center z-10 select-none max-w-6xl mx-auto px-6 pointer-events-auto relative w-full mb-6 sm:mb-8">
          <div className="relative w-full flex flex-col items-center">
            ...
            <motion.div
              ...
              className="absolute right-[4%] sm:right-[10%] md:right-[14%] top-0 sm:-top-2 md:-top-4 z-30 inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2.5 rounded-2xl bg-[#FFE4F3] border-2 border-white shadow-[0_10px_25px_rgba(236,72,153,0.2)] text-[#D91B82] cursor-pointer rotate-[4deg] will-change-transform"
            ...
            <motion.div
              ...
              className="absolute left-[2%] sm:left-[8%] md:left-[12%] top-1/2 -translate-y-1/2 z-30 inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2.5 rounded-2xl bg-[#EFE5FF] border-2 border-white shadow-[0_10px_25px_rgba(124,58,237,0.2)] text-[#5B21B6] cursor-pointer -rotate-[6deg] will-change-transform"
              style={{ transform: "translateZ(0)" }}
            >
            ...
            <motion.div
              ...
              whileHover={{ scale: 1.08, rotate: 0 }}
              className="absolute right-[2%] sm:right-[6%] md:right-[10%] bottom-0 sm:bottom-2 md:bottom-4 z-30 inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2.5 rounded-2xl bg-[#D6F2FE] border-2 border-white shadow-[0_10px_25px_rgba(2,132,199,0.2)] text-[#0284C7] cursor-pointer rotate-[-4deg] will-change-transform"
              style={{ transform: "translateZ(0)" }}
            >
